...
BIO 110 Lab - Chemotaxis - two strains


Link to this page: http://bit.ly/bio110-chemotaxis-two-strains
...
* library(usethis)
* use_course("https://github.com/jeremymcwilliams/bio110-chemotaxis-two-strains/archive/0.8.zip")
